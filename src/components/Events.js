...
class Events extends React.Component {
  ...
  render () {
      const { checkValidation , openDialog , closeDialog , createEvent , openSuccessModal , closeSuccessModal , history} = this.props;      
    return (
        <div>
        <Card
          style={{
        ...
        >
          ...
          >
            <CardText style={{ fontSize: 20 }} >Are you sure you want to create the Event ?</CardText>
          </Dialog>
          <Dialog
            title="Success"
            titleStyle={{
