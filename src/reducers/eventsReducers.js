...
export function eventsReducers (state = {events: []}, action) {
  switch (action.type) {
    ...
    case 'LOGIN_REJECTED': {
      return {
        ...state,
        invalidCredentialErrorMessage: action.err.errors.invalidCredential
          ? action.err.errors.invalidCredential
          : undefined,
        passwordErrorMessage: action.err.errors.password
          ? action.err.errors.password
          : undefined,
        emailErrorMessage: action.err.errors.email
          ? action.err.errors.email
          : undefined
      }
    }
    ...
    case 'SIGNUP_REJECTED': {
      return {
        ...
        passwordErrorMessage: action.error.password
    ...
    case 'SET_EVENT_ID': {
      return {
        ...
        eventName: action.filteredEvents.eventName,
        eventDescription: action.filteredEvents.description,
        duration: action.filteredEvents.duration,
        location: action.filteredEvents.location,
        participantNo: action.filteredEvents.participantNo,
        tags: action.filteredEvents.tags,
        fees: action.filteredEvents.fees
      }
    }
